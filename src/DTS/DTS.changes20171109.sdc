#This is async, so ignore timing to sys clock domain
set_false_path -from {DTS:DTS_1|pdts_endpoint:pdts_endpoint_1|pdts_rx_phy:rxphy|ctr[0]} -to {DTS:DTS_1|monitor.clk_DUNE_in_reset}
