...
TOP_LEVEL_NAME="COLD_DATA_Reset"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/COLD_DATA_Reset/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work COLD_DATA_Reset -cdslib ./cds_libs/COLD_DATA_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work COLD_DATA_Reset -cdslib ./cds_libs/COLD_DATA_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work COLD_DATA_Reset -cdslib ./cds_libs/COLD_DATA_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work COLD_DATA_Reset -cdslib ./cds_libs/COLD_DATA_Reset.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/COLD_DATA_Reset.vhd"                                                                                                    
fi
