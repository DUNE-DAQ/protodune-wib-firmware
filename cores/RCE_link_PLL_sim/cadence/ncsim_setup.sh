...
mkdir -p ./libraries/RCE_link_PLL/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_pll_av/altera_xcvr_functions.sv"      -work RCE_link_PLL -cdslib ./cds_libs/RCE_link_PLL.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_h.sv"                  -work RCE_link_PLL -cdslib ./cds_libs/RCE_link_PLL.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_plls.sv"               -work RCE_link_PLL -cdslib ./cds_libs/RCE_link_PLL.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_pll_av/av_reconfig_bundle_to_xcvr.sv" -work RCE_link_PLL -cdslib ./cds_libs/RCE_link_PLL.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_avmm_csr.sv"           -work RCE_link_PLL -cdslib ./cds_libs/RCE_link_PLL.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_pll_av/alt_xcvr_resync.sv"            -work RCE_link_PLL -cdslib ./cds_libs/RCE_link_PLL.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RCE_link_PLL.vhd"                                                                                           
fi
