...
# # End of template
# ----------------------------------------
# If RCE_link_PLL is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 185 linux 2016.07.28.12:39:51
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "RCE_link_PLL"
}
...
ensure_lib              ./libraries/RCE_link_PLL/
vmap       RCE_link_PLL ./libraries/RCE_link_PLL/
...
alias com {
  echo "\[exec\] com"
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/altera_xcvr_functions.sv"             -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/mentor/altera_xcvr_functions.sv"      -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_h.sv"                         -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_plls.sv"                      -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_reconfig_bundle_to_xcvr.sv"        -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_avmm_csr.sv"                  -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/mentor/av_xcvr_h.sv"                  -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/mentor/av_xcvr_plls.sv"               -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/mentor/av_reconfig_bundle_to_xcvr.sv" -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/mentor/av_xcvr_avmm_csr.sv"           -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/alt_xcvr_resync.sv"                   -work RCE_link_PLL
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/mentor/alt_xcvr_resync.sv"            -work RCE_link_PLL
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/RCE_link_PLL.vhd"                                                          
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L RCE_link_PLL -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L RCE_link_PLL -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
