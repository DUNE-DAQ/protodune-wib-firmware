...
alias com {
  echo "\[exec\] com"
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/altera_xcvr_functions.sv"      -work RCE_link_PLL
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_h.sv"                  -work RCE_link_PLL
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_plls.sv"               -work RCE_link_PLL
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_reconfig_bundle_to_xcvr.sv" -work RCE_link_PLL
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/av_xcvr_avmm_csr.sv"           -work RCE_link_PLL
  eval  vlog  $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_xcvr_pll_av/alt_xcvr_resync.sv"            -work RCE_link_PLL
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L RCE_link_PLL -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L RCE_link_PLL -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
