...
mkdir -p ./libraries/COLDATA_Reset/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work COLDATA_Reset -cdslib ./cds_libs/COLDATA_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work COLDATA_Reset -cdslib ./cds_libs/COLDATA_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work COLDATA_Reset -cdslib ./cds_libs/COLDATA_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work COLDATA_Reset -cdslib ./cds_libs/COLDATA_Reset.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/COLDATA_Reset.vhd"                                                                                                  
fi
