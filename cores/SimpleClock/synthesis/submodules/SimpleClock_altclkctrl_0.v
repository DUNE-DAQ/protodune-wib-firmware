//altclkctrl CBX_SINGLE_OUTPUT_FILE="ON" CLOCK_TYPE="AUTO" DEVICE_FAMILY="Arria V" USE_GLITCH_FREE_SWITCH_OVER_IMPLEMENTATION="OFF" ena inclk outclk
...
module  SimpleClock_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //SimpleClock_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  SimpleClock_altclkctrl_0  (
    inclk,
    outclk);
    ...
    SimpleClock_altclkctrl_0_sub  SimpleClock_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
