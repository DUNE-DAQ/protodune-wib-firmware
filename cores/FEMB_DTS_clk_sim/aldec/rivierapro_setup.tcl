...
# ACDS 16.0 211 linux 2017.11.16.13:17:27
# ----------------------------------------
...
# ----------------------------------------
# If FEMB_DTS_clk is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "FEMB_DTS_clk"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FEMB_DTS_clk.vho"
}
