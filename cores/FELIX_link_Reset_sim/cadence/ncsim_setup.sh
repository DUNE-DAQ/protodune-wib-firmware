...
TOP_LEVEL_NAME="FELIX_link_Reset"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/FELIX_link_Reset/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_functions.sv"     -work FELIX_link_Reset -cdslib ./cds_libs/FELIX_link_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_resync.sv"           -work FELIX_link_Reset -cdslib ./cds_libs/FELIX_link_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/altera_xcvr_reset_control.sv" -work FELIX_link_Reset -cdslib ./cds_libs/FELIX_link_Reset.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_xcvr_reset_control/alt_xcvr_reset_counter.sv"    -work FELIX_link_Reset -cdslib ./cds_libs/FELIX_link_Reset.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FELIX_link_Reset.vhd"                                                                                                     
fi
