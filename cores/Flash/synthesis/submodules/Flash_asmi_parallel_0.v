...
//synthesis_resources = a_graycounter 4 arriav_asmiblock 1 lpm_compare 2 lpm_counter 3 lut 29 mux21 19 reg 186 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  Flash_asmi_parallel_0
	( 
	addr,
	bulk_erase,
	busy,
...
`endif
	...
	wire  [2:0]   wire_pgwr_data_cntr_q;
	wire  [2:0]   wire_pgwr_read_cntr_q;
	...
	wire  not_busy;
	wire  oe_wire;
	wire  [2:0]  page_size_wire;
	wire  [2:0]  pagewr_buf_not_empty;
	wire  [15:0]  prot_wire;
	wire  rden_wire;
	...
	( 
	.aclr(reset),
	.clk_en(((((((((((((((in_operation & end_one_cycle) & (~ (stage3_wire & (~ end_add_cycle)))) & (~ (stage4_wire & (~ end_read)))) & (~ (stage4_wire & (~ end_fast_read)))) & (~ ((((do_write | do_sec_erase) | do_die_erase) | do_bulk_erase) & write_prot_true))) & (~ (do_write & (~ pagewr_buf_not_empty[2])))) & (~ (stage3_wire & st_busy_wire))) & (~ ((do_write & shift_pgwr_data) & (~ end_pgwr_data)))) & (~ (stage2_wire & do_wren))) & (~ ((((stage3_wire & (do_sec_erase | do_die_erase)) & (~ do_wren)) & (~ do_read_stat)) & (~ do_read_rdid)))) & (~ (stage3_wire & ((do_write_volatile | do_read_volatile) | do_read_nonvolatile)))) | ((stage3_wire & do_fast_read) & do_wait_dummyclk)) | addr_overdie) | end_ophdly)),
	.clock(clkin_wire),
	.q(wire_stage_cntr_q),
	.qbin(),
	.sclr((end_operation | addr_overdie))
	...
	.aleb(),
	.aneb(),
	.dataa({page_size_wire[2:0]}),
	.datab({wire_pgwr_data_cntr_q[2:0]})
	`ifndef FORMAL_VERIFICATION
	// synopsys translate_off
	`endif
	,
	...
	.aleb(),
	.aneb(),
	.dataa({wire_pgwr_data_cntr_q[2:0]}),
	.datab({wire_pgwr_read_cntr_q[2:0]})
	`ifndef FORMAL_VERIFICATION
	// synopsys translate_off
	`endif
	,
	...
	defparam
		scfifo10.lpm_numwords = 6,
		scfifo10.lpm_width = 8,
		scfifo10.lpm_widthu = 3,
		scfifo10.use_eab = "ON",
	...
	assign
		...
		illegal_write_b4out_wire = ((do_write & write_prot_true) | (do_write & (~ pagewr_buf_not_empty[2]))),
		...
		oe_wire = 1'b0,
		page_size_wire = 3'b100,
		pagewr_buf_not_empty = {(pagewr_buf_not_empty[1] | wire_pgwr_data_cntr_q[2]), (pagewr_buf_not_empty[0] | wire_pgwr_data_cntr_q[1]), wire_pgwr_data_cntr_q[0]},
...
endmodule //Flash_asmi_parallel_0
//VALID FILE
