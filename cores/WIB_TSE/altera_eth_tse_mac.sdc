...
proc altera_eth_tse_constraint_std_sync {} {
   ...
   altera_eth_tse_constraint_net_delay  *  *altera_eth_tse_std_synchronizer:*|din_s1  6ns
...
proc altera_eth_tse_constraint_clock_crosser {} {
    ...
    set to_reg1 altera_eth_tse_std_synchronizer:in_to_out_synchronizer|din_s1
    
    set from_reg2 in_data_buffer
    set to_reg2 out_data_buffer
    
    set from_reg3 out_data_toggle_flopped
    set to_reg3 altera_eth_tse_std_synchronizer:out_to_in_synchronizer|din_s1
...
altera_eth_tse_constraint_ptr  altera_tse_a_fifo_opt_1246:TX_DATA|altera_tse_gray_cnt:U_RD  g_out  altera_tse_a_fifo_opt_1246:TX_DATA|altera_eth_tse_std_synchronizer_bundle:U_SYNC_1|altera_eth_tse_std_synchronizer:*  din_s1  7.5ns  6ns
# From TX User Clock to MAC TX Clock
altera_eth_tse_constraint_ptr  altera_tse_a_fifo_opt_1246:TX_DATA|altera_tse_gray_cnt:U_WRT  g_out  altera_tse_a_fifo_opt_1246:TX_DATA|altera_eth_tse_std_synchronizer_bundle:U_SYNC_3|altera_eth_tse_std_synchronizer:*  din_s1  7.5ns  6ns

# From RX User Clock to MAC RX Clock
altera_eth_tse_constraint_ptr  altera_tse_a_fifo_opt_1246:RX_DATA|altera_tse_gray_cnt:U_RD  g_out  altera_tse_a_fifo_opt_1246:RX_DATA|altera_eth_tse_std_synchronizer_bundle:U_SYNC_1|altera_eth_tse_std_synchronizer:*  din_s1  7.5ns  6ns
# From MAC RX Clock to RX User Clock
altera_eth_tse_constraint_ptr  altera_tse_a_fifo_opt_1246:RX_DATA|altera_tse_gray_cnt:U_WRT  g_out  altera_tse_a_fifo_opt_1246:RX_DATA|altera_eth_tse_std_synchronizer_bundle:U_SYNC_3|altera_eth_tse_std_synchronizer:*  din_s1  7.5ns  6ns

# From TX User Clock to MAC TX Clock
altera_eth_tse_constraint_ptr  altera_tse_a_fifo_13:TX_STATUS|altera_tse_gray_cnt:U_WRT  g_out  altera_tse_a_fifo_13:TX_STATUS|altera_eth_tse_std_synchronizer_bundle:U_SYNC_2|altera_eth_tse_std_synchronizer:*  din_s1  7.5ns  6ns

# From MAC RX Clock to RX User Clock
altera_eth_tse_constraint_ptr  altera_tse_a_fifo_34:RX_STATUS  wr_g_ptr_reg  altera_tse_a_fifo_34:RX_STATUS  wr_g_rptr  7.5ns  6ns

# GMII loopback
if {[expr ($ENABLE_GMII_LOOPBACK == 1)]} {
   altera_eth_tse_constraint_ptr  altera_tse_a_fifo_24:U_LBFF|altera_tse_gray_cnt:U_RD  g_out  altera_tse_a_fifo_24:U_LBFF  rd_g_wptr  7.5ns  6ns
   altera_eth_tse_constraint_ptr  altera_tse_a_fifo_24:U_LBFF|altera_tse_gray_cnt:U_WRT  g_out  altera_tse_a_fifo_24:U_LBFF  wr_g_rptr  7.5ns  6ns
}
