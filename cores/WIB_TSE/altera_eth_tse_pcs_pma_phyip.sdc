...
if { [ expr ($IS_SGMII == 1)] } {
   altera_eth_tse_constraint_ptr  altera_tse_a_fifo_24:*|altera_tse_gray_cnt:U_RD  g_out  altera_tse_a_fifo_24:*  rd_g_wptr  7.5ns  6ns
   altera_eth_tse_constraint_ptr  altera_tse_a_fifo_24:*|altera_tse_gray_cnt:U_WRT  g_out  altera_tse_a_fifo_24:*  wr_g_rptr  7.5ns  6ns
...
if {[expr ($ENABLE_TIMESTAMPING == 1)]} {
   ...
   if {[llength [query_collection -report -all $regs]] > 0} {
      altera_eth_tse_constraint_ptr  altera_tse_ph_calculator:phase_calculator.ph_cal_inst  wr_ptr_sample  altera_tse_ph_calculator:phase_calculator.ph_cal_inst  sync_wr_ptr[2]  4.5ns  3ns
   }

   set regs [get_registers -nowarn *altera_tse_ph_calculator*sync_rd_ptr[2]*]
   if {[llength [query_collection -report -all $regs]] > 0} {
      altera_eth_tse_constraint_ptr  altera_tse_ph_calculator:phase_calculator.ph_cal_inst  rd_ptr_sample  altera_tse_ph_calculator:phase_calculator.ph_cal_inst  sync_rd_ptr[2]  4.5ns  3ns
   }
}
