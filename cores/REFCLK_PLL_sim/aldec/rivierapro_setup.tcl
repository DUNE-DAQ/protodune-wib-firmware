...
# ACDS 16.0 211 linux 2017.08.14.14:12:46
# ----------------------------------------
...
# ----------------------------------------
# If REFCLK_PLL is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/REFCLK_PLL.vho"
}
