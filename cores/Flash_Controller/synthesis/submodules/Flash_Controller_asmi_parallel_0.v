//altasmi_parallel CBX_AUTO_BLACKBOX="ALL" CBX_SINGLE_OUTPUT_FILE="ON" DATA_WIDTH="QUAD" DEVICE_FAMILY="Arria V" ENABLE_SIM="FALSE" EPCS_TYPE="EPCQ128A" FLASH_RSTPIN="FALSE" PAGE_SIZE=256 PORT_BULK_ERASE="PORT_USED" PORT_DIE_ERASE="PORT_UNUSED" PORT_EN4B_ADDR="PORT_UNUSED" PORT_EX4B_ADDR="PORT_UNUSED" PORT_FAST_READ="PORT_USED" PORT_ILLEGAL_ERASE="PORT_USED" PORT_ILLEGAL_WRITE="PORT_USED" PORT_RDID_OUT="PORT_UNUSED" PORT_READ_ADDRESS="PORT_USED" PORT_READ_DUMMYCLK="PORT_UNUSED" PORT_READ_RDID="PORT_UNUSED" PORT_READ_SID="PORT_UNUSED" PORT_READ_STATUS="PORT_USED" PORT_SECTOR_ERASE="PORT_UNUSED" PORT_SECTOR_PROTECT="PORT_UNUSED" PORT_SHIFT_BYTES="PORT_USED" PORT_WREN="PORT_USED" PORT_WRITE="PORT_USED" USE_ASMIBLOCK="OFF" USE_EAB="ON" WRITE_DUMMY_CLK=0 addr asmi_dataoe asmi_dataout asmi_dclk asmi_scein asmi_sdoin bulk_erase busy clkin data_valid datain dataout fast_read illegal_erase illegal_write rden read_address read_status reset shift_bytes status_out wren write INTENDED_DEVICE_FAMILY="Arria V" ALTERA_INTERNAL_OPTIONS=SUPPRESS_DA_RULE_INTERNAL=C106
//VERSION_BEGIN 17.1 cbx_a_gray2bin 2017:10:19:05:46:40:SJ cbx_a_graycounter 2017:10:19:05:46:40:SJ cbx_altasmi_parallel 2017:10:19:05:46:40:SJ cbx_altdpram 2017:10:19:05:46:40:SJ cbx_altera_counter 2017:10:19:05:46:40:SJ cbx_altera_syncram 2017:10:19:05:46:40:SJ cbx_altera_syncram_nd_impl 2017:10:19:05:46:40:SJ cbx_altsyncram 2017:10:19:05:46:40:SJ cbx_arriav 2017:10:19:05:46:39:SJ cbx_cyclone 2017:10:19:05:46:40:SJ cbx_cycloneii 2017:10:19:05:46:40:SJ cbx_fifo_common 2017:10:19:05:46:40:SJ cbx_lpm_add_sub 2017:10:19:05:46:40:SJ cbx_lpm_compare 2017:10:19:05:46:40:SJ cbx_lpm_counter 2017:10:19:05:46:40:SJ cbx_lpm_decode 2017:10:19:05:46:40:SJ cbx_lpm_mux 2017:10:19:05:46:40:SJ cbx_mgl 2017:10:19:06:38:12:SJ cbx_nadder 2017:10:19:05:46:40:SJ cbx_nightfury 2017:10:19:05:46:40:SJ cbx_scfifo 2017:10:19:05:46:40:SJ cbx_stratix 2017:10:19:05:46:40:SJ cbx_stratixii 2017:10:19:05:46:40:SJ cbx_stratixiii 2017:10:19:05:46:40:SJ cbx_stratixv 2017:10:19:05:46:40:SJ cbx_util_mgl 2017:10:19:05:46:40:SJ cbx_zippleback 2017:10:19:05:46:40:SJ  VERSION_END
...
//synthesis_resources = a_graycounter 4 lpm_compare 2 lpm_counter 3 lut 29 mux21 18 reg 186 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"SUPPRESS_DA_RULE_INTERNAL=C106"} *)
module  Flash_Controller_asmi_parallel_0
	( 
	addr,
	asmi_dataoe,
	asmi_dataout,
...
`endif
	...
	reg	power_up_reg;
	wire	[23:0]	wire_quad_addr_reg_d;
	reg	[23:0]	quad_addr_reg;
	wire	[23:0]	wire_quad_addr_reg_ena;
	...
	assign
		wire_add_msb_quad_reg_d = {quad_addr_reg[23:20]};
	assign
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  add_rollover_reg <= (wire_read_add_cntr_q[24] | clr_read_wire2);
	// synopsys translate_off
	initial
		addr_reg[0:0] = 0;
	// synopsys translate_on
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  buf_empty_reg <= wire_cmpr11_aeb;
	// synopsys translate_off
	initial
		bulk_erase_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_end_rbyte_reg_ena = ((wire_mux218_dataout | clr_endrbyte_wire) | addr_overdie),
	...
	always @ ( negedge clkin_wire or  posedge reset)
		...
		else  max_cnt_reg <= wire_cmpr10_aeb;
	// synopsys translate_off
	initial
		maxcnt_shift_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_pgwrbuf_dataout_d = {(({7{read_bufdly}} & wire_scfifo9_q[7:1]) | ({7{(~ read_bufdly)}} & pgwrbuf_dataout[6:0])), (read_bufdly & wire_scfifo9_q[0])};
	assign
	...
	assign
		wire_pgwrbuf_quad_dataout_d = {(({4{read_bufdly}} & wire_scfifo9_q[7:4]) | ({4{(~ read_bufdly)}} & pgwrbuf_quad_dataout[3:0])), ({4{read_bufdly}} & wire_scfifo9_q[3:0])};
	assign
	...
	always @ ( negedge clkin_wire or  posedge reset)
		if (reset == 1'b1) write_prot_reg <= 1'b0;
			...
			else  write_prot_reg <= ((((do_write | do_sec_erase) & (~ prot_wire[0])) & (((~ mask_prot_comp_ntb[5]) & (~ tb_wire)) | ((~ mask_prot_comp_tb[5]) & tb_wire))) | be_write_prot);
	assign
	...
	assign		wire_mux213_dataout = (do_fast_read === 1'b1) ? end_add_cycle_mux_datab_wire : (wire_addbyte_cntr_q[1] & (~ wire_addbyte_cntr_q[0]));
	assign		wire_mux214a_dataout = ((stage3_wire & do_fast_read) === 1'b1) ? {add_msb_quad_reg[3:0]} : {3'b110, add_msb_reg};
	assign		wire_mux215a_dataout = (do_fast_read === 1'b1) ? {read_dout_quad_reg[7:0]} : {read_dout_reg[7:0]};
	assign		wire_mux216_dataout = (do_fast_read === 1'b1) ? dvalid_reg : dvalid_reg2;
	assign		wire_mux217_dataout = (do_fast_read === 1'b1) ? (((((do_fast_read & end_fast_read) & (~ wire_gen_cntr_q[2])) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) | clr_read_wire2) : (((((do_read | do_fast_read) & (~ wire_gen_cntr_q[2])) & wire_gen_cntr_q[1]) & wire_gen_cntr_q[0]) | clr_read_wire2);
	assign		wire_mux218_dataout = (do_fast_read === 1'b1) ? (((~ wire_gen_cntr_q[2]) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) : ((wire_gen_cntr_q[2] & (~ wire_gen_cntr_q[1])) & wire_gen_cntr_q[0]);
	scfifo   scfifo9
	( 
	.aclr(reset),
	.almost_empty(),
	...
	defparam
		scfifo9.lpm_numwords = 258,
		scfifo9.lpm_width = 8,
		scfifo9.lpm_widthu = 9,
		scfifo9.use_eab = "ON",
		scfifo9.lpm_type = "scfifo";
	assign
		...
		clr_endrbyte_wire = wire_mux217_dataout,
		...
		data_valid_wire = wire_mux216_dataout,
		datain_wire = {((memadd_datain[3] & write_datain[3]) & (~ (((do_fast_read & wire_stage_cntr_q[1]) & wire_stage_cntr_q[0]) & wire_addbyte_cntr_q[2]))), ((memadd_datain[2] & write_datain[2]) & (~ (((do_fast_read & wire_stage_cntr_q[1]) & wire_stage_cntr_q[0]) & wire_addbyte_cntr_q[2]))), (memadd_datain[1] | write_datain[1]), ((((((shift_opdata & asmi_opcode_reg[7]) | rsid_sdoin) | memadd_datain[0]) | write_datain[0]) | secprot_sdoin) | freadwrv_sdoin)},
		...
		end1_cyc_gen_cntr_wire = ((((do_write & wire_gen_cntr_q[2]) & (~ wire_gen_cntr_q[1])) & (~ wire_gen_cntr_q[0])) | ((~ do_write) & wire_mux211_dataout)),
		...
		read_data_reg_in_wire = {wire_mux215a_dataout[7:0]},
		read_opcode = {8{1'b0}},
		read_rdid_wire = 1'b0,
		read_sid_wire = 1'b0,
		...
		wren_wire = wren,
		write_datain = {3'b110, ((((do_write & stage4_wire) & wire_wrstage_cntr_q[1]) & wire_wrstage_cntr_q[0]) & pgwrbuf_dataout[7])},
		write_opcode = 8'b00000010,
		write_prot_true = write_prot_reg,
		write_wire = write_reg,
		wrvolatile_opcode = {8{1'b0}};
endmodule //Flash_Controller_asmi_parallel_0
//VALID FILE
